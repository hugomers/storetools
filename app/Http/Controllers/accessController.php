    ...
    public function createClient(Request $request){
        ...
        if (!$clientes) {
            ...
            $ins = [
                intval($idmax['ID']),
                intval($idmax['ID']),
                mb_convert_encoding((string)$client->nom_cli, "UTF-8", "Windows-1251"),
                mb_convert_encoding((string)$client->nom_cli, "UTF-8", "Windows-1251"),
                mb_convert_encoding((string)$client->street . " " . $client->num_int . " " . $client->num_ext, "UTF-8", "Windows-1251"),
                mb_convert_encoding((string)$client->estado, "UTF-8", "Windows-1251"),
                $client->cp,
                mb_convert_encoding((string)$client->mun, "UTF-8", "Windows-1251"),
                $celphone,
                500,
                'EFE',
                $client->price,
